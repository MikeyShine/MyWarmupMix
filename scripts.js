...
var MIXES = [
  ...
  { id:18, series:'warmup',   title:'Warm-Up Mix Vol. 2',  tags:['High Energy','Open Format','30 Min'],               price:'24.99', tracks:['Pitbull & Ne-Yo – Give Me Everything','LMFAO – Party Rock Anthem','Taio Cruz – Dynamite','Flo Rida – Good Feeling','will.i.am & Britney Spears – Scream & Shout','Macklemore – Can\'t Hold Us','Robin Thicke – Blurred Lines','Pharrell – Happy','Mark Ronson & Bruno Mars – Uptown Funk','Justin Timberlake – Can\'t Stop the Feeling','Meghan Trainor – All About That Bass','Iggy Azalea & Charli XCX – Fancy','Nicki Minaj – Super Bass','Drake – Started From the Bottom','Kanye West – Power','Jay-Z & Alicia Keys – Empire State of Mind','T.I. & Rihanna – Live Your Life','Ludacris & Usher – Yeah!','OutKast – Hey Ya!','Missy Elliott – Work It'] },
  { id:19, series:'warmup',   title:'Warm-Up Mix Vol. 3',  tags:['High Energy','Open Format','30 Min'],               price:'24.99', tracks:['The Weeknd – Can\'t Feel My Face','Drake – Hotline Bling','Kendrick Lamar – HUMBLE.','Cardi B – I Like It','Bruno Mars & Cardi B – Finesse','Post Malone & Swae Lee – Sunflower','Travis Scott – Goosebumps','Dua Lipa – New Rules','Lizzo – Good as Hell','Billie Eilish – bad guy','Ariana Grande – 7 Rings','Ed Sheeran – Shape of You','Bruno Mars – 24K Magic','Jason Derulo – Want to Want Me','Maroon 5 – Sugar','Luis Fonsi & Daddy Yankee – Despacito','J Balvin & Willy William – Mi Gente','Bad Bunny & Drake – MIA','Shakira & Rihanna – Can\'t Remember to Forget You','Ozuna – Taki Taki'] },
  { id:20, series:'warmup',   title:'Warm-Up Mix Vol. 4',  tags:['High Energy','Open Format','30 Min'],               price:'24.99', tracks:['The Weeknd – Blinding Lights','Dua Lipa – Levitating','Harry Styles – As It Was','Olivia Rodrigo – good 4 u','Jack Harlow – First Class','Lizzo – About Damn Time','Doja Cat – Say So','Drake – Toosie Slide','Justin Bieber & The Kid LAROI – Stay','Post Malone – Circles','Lil Nas X – Old Town Road','Megan Thee Stallion – Body','SZA – Shirt','Beyoncé – BREAK MY SOUL','Adele – Easy On Me','Ed Sheeran – Bad Habits','Charlie Puth – Light Switch','Dua Lipa – Don\'t Start Now','Bad Bunny – Me Porto Bonito','J Balvin – In Da Getto'] }
];
